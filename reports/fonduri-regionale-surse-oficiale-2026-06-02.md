...
| Subiect | Sursa oficiala | URL | Folosit pentru |
| --- | --- | --- | --- |
| Componenta regiunilor de dezvoltare | Portal Legislativ - Legea nr. 315/2004 | https://legislatie.just.ro/Public/DetaliiDocument/65881 | denumirea regiunilor si judetele componente |
...
| Program Regional Vest | ADR Vest / PR Vest | https://www.vest.ro/ | link oficial program regional |
| Program Regional Nord-Vest | Regio Nord-Vest | https://regionordvest.ro/ | link oficial program regional |
| Programul Regiunea Centru | ADR Centru / Regio Centru | https://www.regiocentru.ro/ | link oficial program regional |
| Program Regional Bucuresti-Ilfov | ADRBI | https://www.adrbi.ro/programe-regionale/por-bi-2021-2027/?external=1 | link oficial program regional |

## Gate editorial

- Nu au fost introduse valori de grant, procente, termene de depunere sau statusuri de apel.
- Pentru Nord-Est, pagina copil ramane `/fonduri-europene-nord-est`, iar programul specific pentru microintreprinderi ramane `/por-adr-nord-est`.
- Pentru toate regiunile, detaliile schimbatoare trebuie confirmate in ghidul activ si in pagina oficiala a programului regional.
