...
|---|---|---|---|---|---|---|---|
| program_status | local | **FAIL** | critical | Consultant FABER + Content owner | /pro-infra<br>/digitalizare-imm<br>/granturi-digitalizare-imm | 2 programe prioritare nu au validare nominală FABER: pro-infra, digitalizare-imm. Contract tehnic: PASS. Poarta P0.02: rândurile aprobate sunt publice, cele disputate rămân blocate și validarea nominală este obligatorie. | Consultantul FABER aprobă fiecare rând, apoi se rerulează gate-ul complet. |
...
| sitemap | local | **PASS** | critical | Technical SEO | /sitemap.xml | Verified sitemap index with 93 canonical URLs; 15 verified lastmod values. | Reexecută verificarea sitemap după remediere/aprobare. |
| editorial | local | **PASS** | high | Editor coordonator | /sitemap.xml | Editorial copy contract passed: 93 canonical URLs, zero forbidden template labels or control-list forms. \| Editorial terminology contract passed: 93 canonical URLs and 10 P0.14 surfaces. | Reexecută verificarea editorial după remediere/aprobare. |
