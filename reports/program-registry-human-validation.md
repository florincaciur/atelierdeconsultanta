...
|---|---|---|---|---|
| dr12-afir | /dr12-afir | verifiedAt, sourceUrl, sourceVersion, lastMeaningfulUpdate, status, validatorName | https://www.afir.ro/comunicate/consultare-publica-pentru-consolidarea-exploatatiilor-tinerilor-fermieri/ | Statusul, documentul și data trebuie confirmate nominal de un consultant FABER înainte de revenirea publicationState la public. |
| dr14-afir | /dr14 | verifiedAt, sourceUrl, sourceVersion, lastMeaningfulUpdate, status, grantSummary, cofinancingSummary, validatorName | https://www.afir.ro/api/file?filename=Ghidul+Solicitantului+DR-14+VARIANTA+CONSULTATIV%C4%82&filetype=pdf&url=%2Fmedia%2Fbkmpo5fo%2Fgs-consultativ-dr-14.pdf | Confirmare nominală FABER obligatorie; valorile consultative nu se publică înainte de aprobare. |
