...
const { renderPriorityCarousel } = require("../tools/sync-homepage-programs");
...
assert.doesNotMatch(renderPriorityCarousel(programs), /\s(?:data-[a-z0-9-]+|hidden|inert)(?=[\s>])/iu, "atributele caruselului trebuie serializate identic cu generatorul fluxului homepage");
