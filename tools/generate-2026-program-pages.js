...
const PAGE_CONTENT = {
  "diaspora-investeste-acasa": {
    ...
    faqs: [["Este deschisă depunerea?", "Nu. La data verificării este publicată comunicarea programului, nu o procedură de înscriere cu termen activ."], ["Grantul poate ajunge la 200.000 euro?", "Comunicarea oficială indică maximum 200.000 euro și maximum 60% din creditul de investiții; plafonul final se verifică în procedura aplicabilă."], ["Este suficient să fi lucrat în străinătate?", "Nu presupunem acest lucru. Condiția anunțată privește domiciliul sau reședința și deținerea majoritară; documentele exacte urmează să fie definite."], ["Pot înființa firma înainte de apel?", "Momentul optim depinde de condiția de întreprindere nou-înființată din procedura viitoare. Nu lua o decizie ireversibilă înainte de publicarea regulilor."], ["Este necesar un credit?", "Mecanismul anunțat este legat de un credit de investiții, deci bancabilitatea face parte din pregătire."], ["Ce pot pregăti acum?", "Profilul solicitantului, conceptul, piața, amplasamentul, ofertele, bugetul și sursele financiare, toate marcate ca versiune de lucru."]]
  },
  "e-drive": {
    eyebrow: "Transport rutier · vehicule cu emisii zero",
    lead: "Schema e-DRIVE explicată pentru operatorii de transport de persoane: două măsuri, categorii diferite de vehicule și obligații care trebuie bugetate înaintea achiziției.",
    metrics: [["50 mil. €", "buget total al schemei"], ["15 mil. €", "alocare de minimis"], ["35 mil. €", "alocare competitivă"], ["max. 4 mil. €", "per beneficiar în măsura competitivă"]],
    answer: "e-DRIVE este o schemă aprobată pentru înlocuirea vehiculelor poluante utilizate la transportul rutier de persoane cu vehicule exclusiv electrice. Măsura de minimis și măsura competitivă au plafoane și categorii de vehicule diferite. Aprobarea schemei nu echivalează cu deschiderea depunerii.",
    fit: ["Desfășori legal transport rutier de persoane în activitățile acoperite de schemă.", "Vehiculele propuse sunt noi și exclusiv electrice, din categoria permisă măsurii alese.", "Poți respecta casarea vehiculului poluant și menținerea investiției pe perioada prevăzută."],
    caution: ["Autoturismele hibride și cele hibride reîncărcabile nu sunt tratate ca vehicule exclusiv electrice.", "Pentru fiecare vehicul finanțat trebuie urmărită obligația de casare în termenul schemei.", "Ajutorul competitiv se raportează la costul eligibil suplimentar față de alternativa convențională."],
    investments: [["Măsura 1 · de minimis", "Vehicule electrice din categoriile M1 și M2, în limita plafonului de 300.000 euro pe întreprindere unică și a regulilor de minimis."], ["Măsura 2 · competitivă", "Vehicule electrice M1, M2 și M3, cu un plafon de până la 4 milioane euro per beneficiar și reguli competitive."], ["Tranziția flotei", "Analiza include vehiculele scoase din uz, capacitatea de încărcare, asigurarea, mentenanța și exploatarea noii flote."]],
    documents: [["Eligibilitatea operatorului", "Certificat constatator, autorizații/licențe, activitatea CAEN și structura întreprinderii unice."], ["Flota existentă", "Inventar, proprietate, caracteristici tehnice și vehiculele propuse pentru casare."], ["Configurația noii flote", "Oferte, categorie de omologare, autonomie, capacitate, garanții și calendar de livrare."], ["Planul financiar", "Cost de referință, ajutor solicitat, surse proprii, TVA și costurile operaționale neeligibile."]],
    steps: ["Alege măsura după categoria vehiculelor și valoarea ajutorului.", "Verifică activitatea autorizată și încadrarea ca întreprindere unică.", "Corelează fiecare vehicul nou cu obligația de casare și cu infrastructura de încărcare.", "Depune numai după publicarea calendarului și a procedurii operaționale."],
    extraSources: [["Ordinul de modificare nr. 100/12.02.2026", "https://legislatie.just.ro/Public/DetaliiDocument/307361"]],
    faqs: [["Programul e-DRIVE este deschis?", "Nu. Schema este aprobată, dar pagina nu identifică un termen activ de depunere confirmat oficial."], ["Sunt eligibile vehiculele hibride?", "Schema vizează vehicule exclusiv electrice; o ofertă hibridă nu trebuie tratată drept echivalent."], ["Care este plafonul de minimis?", "Măsura 1 folosește plafonul de 300.000 euro pe întreprindere unică, cu verificarea tuturor ajutoarelor relevante."], ["Ce înseamnă măsură competitivă?", "Proiectele intră într-o procedură în care ajutorul și costul eligibil sunt stabilite conform criteriilor schemei și documentelor apelului."], ["Casarea este obligatorie?", "Ordinul stabilește casarea unui vehicul diesel pentru fiecare vehicul finanțat, în termenul și condițiile prevăzute de schemă."], ["Cât trebuie păstrată investiția?", "Schema stabilește o perioadă de menținere; forma aplicabilă și obligațiile contractuale trebuie verificate înaintea depunerii."]]
  },
  "e-mobility-ro": {
  ...
  "fondul-modernizare-pc1-stocare": {
    ...
    lead: "Un cadru de pregătire pentru capacități de stocare stand-alone racordate la rețea, construit pe documentația oficială de consultare și marcat explicit ca nefinal.",
    metrics: [["150 mil. €", "buget propus"], ["max. 15 mil. €", "per întreprindere"], ["69.000 €/MWh", "plafon propus al ajutorului"], ["stand-alone", "stocare racordată la rețea"]],
    answer: "Documentația publicată în consultare vizează investiții noi în capacități de stocare stand-alone, conectate la rețea. Sunt menționate întreprinderi de diferite dimensiuni, inclusiv nou-înființate în anumite condiții. Valorile, grila și calendarul se pot schimba până la aprobarea formei finale.",
    ...
    caution: ["Pagina nu descrie un apel deschis; sursa este documentație de consultare.", "Plafonul pe MWh este o limită propusă, nu o promisiune de finanțare la valoarea maximă.", "Racordarea, licențierea și veniturile din piața de energie necesită analiză separată."],
    investments: [["Sisteme de baterii", "Echipamente noi de stocare, conversie, control, protecție și monitorizare, în limita formei finale a ghidului."], ["Lucrări și racordare", "Construcții, instalații și componente de racordare direct legate de punerea în funcțiune a capacității."], ["Proiectare și integrare", "Studii și servicii tehnice eligibile numai dacă sunt prevăzute și încadrate corect în documentația finală."]],
    ...
    steps: ["Fixează puterea și capacitatea numai după o analiză de racordare și piață.", "Verifică solicitantul, CAEN-ul și situația financiară în forma finală a ghidului.", "Construiește un buget trasabil pe MWh și un calendar realist de autorizare.", "Revalidează toate valorile după aprobarea ghidului și înaintea unei decizii de investiție."],
    extraSources: [["Cadrul Fondului pentru Modernizare – OUG nr. 60/2022", "https://legislatie.just.ro/Public/DetaliiDocument/294449"]],
    faqs: [["Apelul PC1 stocare este deschis?", "Nu. Pagina folosește documentația de consultare și nu indică un termen activ de depunere."], ["Ce înseamnă stand-alone?", "Capacitatea de stocare este proiectată ca activ distinct conectat la rețea, nu doar ca anexă a unei centrale de producție pentru autoconsum."], ["Pot aplica firme nou-înființate?", "Documentația de consultare le menționează în anumite condiții, inclusiv cerințe de capital; forma finală trebuie verificată."], ["Finanțarea ajunge la 15 milioane euro?", "Acesta este plafonul propus per întreprindere. Ajutorul se limitează și prin valoarea pe MWh, buget și regulile finale."], ["Este finanțarea 100%?", "Documentația consultativă indică un maximum posibil; costurile neeligibile, depășirile și condițiile finale rămân în sarcina beneficiarului."], ["Ce poate bloca proiectul?", "Lipsa unei soluții de racordare, drepturile insuficiente asupra terenului, calendarul de autorizare și un model economic neverificat sunt riscuri majore."]]
  }
};
...
<main>
  ...
  <section class="program-section"><div class="section-heading"><p class="section-kicker">Filtru inițial</p><h2>Merită continuată analiza?</h2><p>Aceste repere ajută la triere; nu înlocuiesc verificarea documentelor solicitantului și a formei oficiale aplicabile.</p></div><div class="program-fit-grid"><article class="fit-card fit-card--yes"><h3>Profil care merită verificat</h3>${renderList(content.fit)}</article><article class="fit-card fit-card--caution"><h3>Oprește presupunerile aici</h3>${renderList(content.caution)}</article></div></section>
