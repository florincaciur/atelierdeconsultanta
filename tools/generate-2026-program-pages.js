...
function renderSynchronizedPage(program, content) {
  return synchronizeFaqHtml(synchronizedHtml(`${renderPage(program, content)}\n`, program.pageUrl)).html;
}
